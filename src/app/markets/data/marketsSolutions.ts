...
const DC_PRODUCTS_CATEGORY_ID = 571;

const DC_PRODUCTS_CATEGORY_HREF = contentDetailPath(
  "/product-category",
  DC_PRODUCTS_CATEGORY_ID,
  "dc-devices",
);
...
export const marketsSolutionZones: SolutionZone[] = [
  {
    ...
    products: [
      solutionProduct(
        ...
        "SCADA",
        productImg.scada,
        contentDetailPath("/product", 1727, "scada"),
      ),
    ],
  },
  {
  ...
  },
  {
    ...
    products: [
      solutionProduct(
        ...
        productImg.metalClad,
        contentDetailPath("/product", 1691, "metal-clad-switchgear"),
      ),
      solutionProduct(
        "c-metal-enclosed",
      ...
      solutionProduct(
        ...
        "UL 1558 Switchgear",
        productImg.ul1558,
        contentDetailPath("/product", 1674, "ul-1558-switchgear"),
      ),
      solutionProduct(
        "c-ul67",
        "UL 67 Panelboard",
        productImg.ul67Panelboard,
        contentDetailPath("/product", 1671, "ul-67-panelboard"),
      ),
      solutionProduct(
        "c-padmount",
        "Padmount Transformer",
        productImg.padmount,
        contentDetailPath("/product", 1693, "padmount-transformer"),
      ),
      solutionProduct(
        "c-cast-resin",
        "Cast Resin Transformer",
        productImg.castResin,
        contentDetailPath("/product", 1694, "cast-resin-transformer"),
      ),
      solutionProduct(
        "c-lis",
        "Load Interrupter Switch",
        productImg.loadInterrupter,
        contentDetailPath("/product", 1690, "load-interrupter-switch"),
      ),
      solutionProduct(
        "c-vcb",
        "Susol UL VCB",
        productImg.susolVcb,
        contentDetailPath("/product", 1689, "susol-ul-vcb"),
      ),
      solutionProduct(
        "c-mccb",
        "Susol UL MCCB",
        productImg.susolMccb,
        contentDetailPath("/product", 1665, "susol-ul-mccb"),
      ),
      solutionProduct(
        "c-dc",
        "DC Products",
        productImg.dcProducts,
        DC_PRODUCTS_CATEGORY_HREF,
      ),
    ],
  },
  {
    ...
    products: [
      solutionProduct(
        ...
        "E-House",
        productImg.eHouse,
        contentDetailPath("/product", 1695, "e-house"),
      ),
    ],
  },
  {
  ...
  },
  {
    ...
    products: [
      solutionProduct(
        ...
        contentDetailPath("/product", 1696, "power-transformer"),
      ),
    ],
  },
  {
