...
export const powerGridReferences: ReferenceItem[] = [
  ...
  },
  {
    ...
    description:
      "The Qcells Redeemer Project, located in Cartersville, Georgia, is one of North America’s largest integrated solar manufacturing facilities. The facility encompasses the entire solar manufacturing process, from ingot and wafer production to cell and module assembly.",
