...
export default function DevicesSmartFactoryOverview() {
  ...
  return (
    <section className="devices_smart_factory_overview" id="product-overview">
      <div className="inner">
        <div
          className="devices_smart_factory_overview__visual"
          style={{ backgroundImage: `url(${smartFactoryOverview.image})` }}
          role="img"
          aria-label={smartFactoryOverview.imageAlt}
        />
        <div className="devices_smart_factory_overview__body">
          <h2 className="devices_smart_factory_overview__title">
          ...
          <p className="devices_smart_factory_overview__desc">
