...
const PRODUCTS_MOBILE_SLIDES_PER_VIEW = 1.15;
...
function ProductsSwiperPer4({ products }: ProductsSwiperPer4Props) {
  ...
  const slidesPerView = isDesktop
    ...
    : PRODUCTS_MOBILE_SLIDES_PER_VIEW;
  const loopEnabled = canEnableProductLoop(products.length, slidesPerView);
  const pageCount = getPageCount(products.length, slidesPerView);
    ...
    <div className="products_swipers per4">
      <div className="products_swipers_area">
        <Swiper
          ...
          breakpoints={{
            0: {
              slidesPerView: PRODUCTS_MOBILE_SLIDES_PER_VIEW,
              spaceBetween: 12,
            },
            781: {
